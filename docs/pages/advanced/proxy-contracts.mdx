...
The `create-ponder-fork` Etherscan [contract link template](/api-reference/create-ponder-fork#etherscan-contract-link) automatically detects proxy contracts and fetches all implementation contract ABIs.
